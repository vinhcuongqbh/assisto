        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-default">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('track.search') }}" method="post"
                        id="track-search">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="date" class="col-3 col-md-2 col-form-label">{{ __('date') }}</label>
                                ...
                                <tbody>
                                    @foreach ($tracks as $track)
                                        <tr>
                                            <td>
                                                <a
                                                    href="{{ route('track.show', $track->track_id) }}">TRACK{{ $track->track_id }}</a>
                                            </td>
