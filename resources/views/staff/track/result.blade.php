        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-default">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('staff.track.search') }}" method="post" id="track-search">
                        @csrf
                        <div class="card-body">
                            ...
                            <table id="search-table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($tracks as $track)
                                        <tr>
                                            <td>
                                                <a href="{{ route('staff.track.show', $track->track_id) }}">TRACK{{ $track->track_id }}</a>
                                            </td>
