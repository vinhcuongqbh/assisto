        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-default">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('staff.accident.search') }}" method="post" id="accident-search">
                        @csrf
                        <div class="card-body">
